...
contract ERC721Token is ERC721, Governance, IERC2981 {
    ...
    constructor() public ERC721("Pinks", "PINKS") {
        _setBaseURI("https://raw.githubusercontent.com/nft-artist/nft/master/plinks/");
	...
	function mint(address _to, uint256 _tokenId) public {
		...
		_mint(_to, _tokenId);
        _setTokenURI(_tokenId, string(abi.encodePacked(StringUtil.uintToString(_tokenId), ".json")));
        _royaltyInfos[_tokenId].creator = msg.sender;
